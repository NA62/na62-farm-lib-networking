...
UDP_HDR* EthernetUtils::GenerateUDP(const void* buffer, const char* dMacAddr, const uint32_t dIP, const uint_fast16_t& sPort, const uint_fast16_t& dPort) {
	...
	hdr->ip.saddr = NetworkHandler::GetMyIP(); // Source IP
